...
pub fn upload_file(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            let mut file_byte_upload = file_upload_clone.lock().unwrap();
            *file_byte_upload = true;

            println!(
                "upload_file: file_byte_upload = {}",
                *file_byte_upload
            );
            // ftp_app_locked.set_file_byte_upload(true);
            //  if ftp_app_locked.get_file_byte_upload() {
            //     println!("file_byte_upload успешно изменён на true!");
            // } else {
            //     println!("file_byte_upload не изменился.");
            // }
            // ftp_app.set_file_byte_upload(true);

            // // Проверяем, что значение изменилось
            // if ftp_app.get_file_byte_upload() {
            //     println!("file_byte_upload успешно изменён на true!");
            // } else {
            //     println!("file_byte_upload не изменился.");
            // }
